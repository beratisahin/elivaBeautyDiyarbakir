...
function Hakkimizda() {
  useDocumentTitle("Diyarbakır Eliva Beauty Güzellik Salonu");
  return (
    <div className="col-12">
      ...
      >
        ...
        <div className="card-body col-12" style={{ padding: "3rem" }}>
          ...
          <p class="hizmetyazi">
            Diyarbakır Eliva Beauty Güzellik Salonu olarak Lazer Epilasyon, G5
            ...
            müşterimize hizmet verebilmekteyiz.
                ...
                <p className="instaLink" style={{textAlign:"center",color:"gray"}}>Detaylı güncel fotoğraf ve videolar için <a className="instagram"  href="https://www.instagram.com/elivabeauty.Diyarbakır/" target="_blank">Diyarbakır Eliva Beauty Güzellik Salonu</a> instagram profilimizi ziyaret edebilirsiniz. </p>
